...
yarn dev evaluate https://github.com/folio-org/mod-users

# Or use ts-node directly
yarn ts-node src/cli.ts evaluate <repo-url>
```
...
yarn build && node dist/cli.js info
